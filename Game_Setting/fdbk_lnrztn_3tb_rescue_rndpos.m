%% game_feedback_linearization_3bots_rescue.m
clear; clc; close all;
rosshutdown; pause(1);
rosinit; pause(1);
...
% Use your rescue-mode function here:
[attackertraj, targettraj, defendertraj, simTimeVec, capture_info, Ux, Uy] = ...
    simulateRescue(t1, t2, t3); % <-- Use your rescue mode trajectory generator

%% 4) Main Control Loop: Scaled Feedback Linearization
