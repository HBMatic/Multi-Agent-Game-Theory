%% game_feedback_linearization_4bots_rescue.m
clear; clc; close all;
rosshutdown; pause(1);
rosinit; pause(1);
...
msg_t1 = rosmessage(pub_t1); msg_t2 = rosmessage(pub_t2); msg_t3 = rosmessage(pub_t3); msg_t4 = rosmessage(pub_t4);
...
%% 3) Reference Trajectories for Rescue Mode
% Replace with your rescue trajectory generator
[attackertraj, targettraj, defendertraj, simTimeVec, capture_info, Ux, Uy] = ...
    simulateRescue(t1, t2, [t3, t4]);
