...
sub_t1 = rossubscriber('/tb3_2/odom','nav_msgs/Odometry');
sub_t2 = rossubscriber('/tb3_3/odom','nav_msgs/Odometry');
sub_t3 = rossubscriber('/tb3_4/odom','nav_msgs/Odometry');
...
pub_t1 = rospublisher('/tb3_2/cmd_vel','geometry_msgs/Twist');
pub_t2 = rospublisher('/tb3_3/cmd_vel','geometry_msgs/Twist');
pub_t3 = rospublisher('/tb3_4/cmd_vel','geometry_msgs/Twist');
