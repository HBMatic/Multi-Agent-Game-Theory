...
errorCustomODM = norm(finalODEPose - finalCustomPose);
errorCoreODM = norm(finalODEPose - finalCorePose);

% Display errors
disp(['Error between Custom Odometry and ODE Trajectory: ', num2str(errorCustomODM), ' meters']);
disp(['Error between ODE Trajectory and TurtleBot Core Odometry: ', num2str(errorCoreODM), ' meters']);
